...
#define OMEGA_DECLARE_SAFE_PROXY_DECLARED_METHOD_VOID(name,param_count,params) \
...
#define OMEGA_DECLARE_SAFE_PROXY_DECLARED_METHOD(ret_type,name,param_count,params) \
...
#define OMEGA_READ_PARAM_WIRE_PROXY_I(meta,t,name) \
	interface_info<t>::wire_type::proxy_read(m_pManager,__wire__pParamsIn,name OMEGA_WIRE_WRITE_PARAM(meta,t,name) );
...
#define OMEGA_WRITE_PARAM_WIRE_PROXY_I(meta,t,name) \
	interface_info<t>::wire_type::proxy_write(m_pManager,__wire__pParamsOut,name OMEGA_WIRE_WRITE_PARAM(meta,t,name) );
