...
namespace Activation
{
	...
	{
		virtual void GetRegisteredObject(const guid_t& oid, const guid_t& iid, IObject** ppObject) = 0;
...
(
	...
	// Methods
	OMEGA_METHOD_VOID(GetRegisteredObject,3,((in),const Omega::guid_t&,oid,(in),const Omega::guid_t&,iid,(out)(iid_is(iid)),Omega::IObject**,ppObject))
)
