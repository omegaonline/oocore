...
namespace Omega
{
	namespace Remoting
	{
		...
		interface IObjectManager : public IObject
		{
			...
			virtual void SetProxyStubFactory(System::IWireProxyStubFactory* pPSFactory) = 0;
...
(
	...
	OMEGA_METHOD_VOID(SetProxyStubFactory,1,((in),System::IWireProxyStubFactory*,pPSFactory))
