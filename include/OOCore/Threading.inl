...
template <class T>
Omega::System::AtomicOp<T>::AtomicOp(const T& v) :
	m_value(v)
{
}
...
template <class T>
T Omega::System::AtomicOp<T>::operator ++()
{
	Guard guard(m_cs);
	return ++m_value;
}
...
template <class T>
T Omega::System::AtomicOp<T>::operator ++(int)
{
	return ++*this - 1;
}
...
template <class T>
volatile T* Omega::System::AtomicOp<T>::operator &()
{
	return &m_value;
}
...
template <class T>
Omega::System::AtomicOp<T>& Omega::System::AtomicOp<T>::operator = (const T& rhs)
{
	Guard guard(m_cs);
	m_value = rhs;
	return *this;
...
Omega::System::AtomicOp<Omega::int32_t>::AtomicOp(const AtomicOp& rhs) :
	m_value(rhs.m_value)
{
}
...
Omega::System::AtomicOp<Omega::uint32_t>::AtomicOp(const AtomicOp& rhs) :
	m_value(rhs.m_value)
{
}
