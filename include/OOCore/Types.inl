...
OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t_assign,2,((in),void*,h1,(in),const void*,h2));
...
OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t_add,2,((in),void*,h,(in),const void*,h2));
Omega::string_t& Omega::string_t::operator += (const string_t& s)
{
...
OMEGA_EXPORTED_FUNCTION(int,OOCore_string_t_cmp,2,((in),const void*,h1,(in),const void*,h2));
int Omega::string_t::Compare(const string_t& s) const
{
	return OOCore_string_t_cmp(m_handle,s.m_handle);
}

OMEGA_EXPORTED_FUNCTION(int,OOCore_string_t_cnc,2,((in),const void*,h1,(in),const void*,h2));
