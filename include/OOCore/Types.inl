...
OMEGA_EXPORTED_FUNCTION(const wchar_t*,OOCore_string_t_cast,1,((in),const void*,h));
...
OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t__ctor1,0,());
Omega::string_t::string_t() :
	m_handle(static_cast<handle_t*>(OOCore_string_t__ctor1()))
{
	OMEGA_DEBUG_STASH_STRING();
}
...
OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t__ctor3,1,((in),const void*,s1));
Omega::string_t::string_t(const Omega::string_t& s) :
	m_handle(static_cast<handle_t*>(OOCore_string_t__ctor3(s.m_handle)))
{
	OMEGA_DEBUG_STASH_STRING();
}

OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t__ctor4,2,((in),const wchar_t*,wsz,(in),size_t,length));
Omega::string_t::string_t(const wchar_t* wsz, size_t length) :
	m_handle(static_cast<handle_t*>(OOCore_string_t__ctor4(wsz,length)))
{
	OMEGA_DEBUG_STASH_STRING();
}

OMEGA_EXPORTED_FUNCTION_VOID(OOCore_string_t__dctor,1,((in),void*,h));
Omega::string_t::~string_t()
{
	OOCore_string_t__dctor(m_handle);
}

OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t_assign_1,2,((in),void*,h1,(in),const void*,h2));
...
OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t_assign_3,2,((in),void*,h,(in),const wchar_t*,wsz));
Omega::string_t& Omega::string_t::operator = (const wchar_t* wsz)
{
	m_handle = static_cast<handle_t*>(OOCore_string_t_assign_3(m_handle,wsz));
	OMEGA_DEBUG_STASH_STRING();
	return *this;
}
...
OMEGA_EXPORTED_FUNCTION(size_t,OOCore_string_t_toutf8,3,((in),const void*,h,(in),char*,sz,(in),size_t,size));
...
OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t_add1,2,((in),void*,h,(in),const void*,h2));
Omega::string_t& Omega::string_t::operator += (const string_t& s)
{
...
OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t_add3,2,((in),void*,h,(in),const wchar_t*,wsz));
Omega::string_t& Omega::string_t::operator += (const wchar_t* wsz)
{
	m_handle = static_cast<handle_t*>(OOCore_string_t_add3(m_handle,wsz));
	OMEGA_DEBUG_STASH_STRING();
	return *this;
}

OMEGA_EXPORTED_FUNCTION(int,OOCore_string_t_cmp1,2,((in),const void*,h1,(in),const void*,h2));
int Omega::string_t::Compare(const string_t& s) const
{
	return OOCore_string_t_cmp1(m_handle,s.m_handle);
}

OMEGA_EXPORTED_FUNCTION(int,OOCore_string_t_cmp3,2,((in),const void*,h1,(in),const wchar_t*,wsz));
int Omega::string_t::Compare(const wchar_t* wsz) const
{
	return OOCore_string_t_cmp3(m_handle,wsz);
}

OMEGA_EXPORTED_FUNCTION(int,OOCore_string_t_cnc1,2,((in),const void*,h1,(in),const void*,h2));
int Omega::string_t::CompareNoCase(const string_t& s) const
{
	return OOCore_string_t_cnc1(m_handle,s.m_handle);
}

OMEGA_EXPORTED_FUNCTION(int,OOCore_string_t_cnc3,2,((in),const void*,h1,(in),const wchar_t*,wsz));
...
OMEGA_EXPORTED_FUNCTION(size_t,OOCore_string_t_len,1,((in),const void*,h));
size_t Omega::string_t::Length() const
{
	return OOCore_string_t_len(m_handle);
}

OMEGA_EXPORTED_FUNCTION(size_t,OOCore_string_t_find1,3,((in),const void*,h1,(in),const void*,h2,(in),size_t,s));
...
{
	if (!bIgnoreCase)
		return OOCore_string_t_find3(m_handle,c,pos,0);
	else
...
{
	if (!bIgnoreCase)
		return OOCore_string_t_rfind2(m_handle,c,pos,0);
	else
		return OOCore_string_t_rfind2(this->ToLower().m_handle,c,pos,1);
}

OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t_left,2,((in),const void*,a,(in),size_t,b));
...
OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t_mid,3,((in),const void*,h,(in),size_t,a,(in),size_t,b));
...
OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t_right,2,((in),const void*,a,(in),size_t,b));
...
OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t_clear,1,((in),void*,h));
Omega::string_t& Omega::string_t::Clear()
{
	m_handle = static_cast<handle_t*>(OOCore_string_t_clear(m_handle));
	OMEGA_DEBUG_STASH_STRING();
	return *this;
}

OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t_tolower,1,((in),const void*,h));
Omega::string_t Omega::string_t::ToLower() const
{
	return string_t(static_cast<handle_t*>(OOCore_string_t_tolower(m_handle)));
}

OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t_toupper,1,((in),const void*,h));
Omega::string_t Omega::string_t::ToUpper() const
{
	return string_t(static_cast<handle_t*>(OOCore_string_t_toupper(m_handle)));
}

OMEGA_EXPORTED_FUNCTION(void*,OOCore_string_t_format,2,((in),const wchar_t*,sz,(in),va_list*,a));
