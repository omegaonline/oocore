...
namespace Omega
{
	namespace Compartment
	{
		...
		{
			virtual void CreateObject(const any_t& oid, Activation::Flags_t flags, const guid_t& iid, IObject*& pObject) = 0;
		};
...
(
	...
	OMEGA_METHOD_VOID(CreateObject,4,((in),const any_t&,oid,(in),Activation::Flags_t,flags,(in),const guid_t&,iid,(out)(iid_is(iid)),IObject*&,pObject))
)
