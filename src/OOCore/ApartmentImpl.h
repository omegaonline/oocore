...
namespace OOCore
{
	...
	public:
		...
		void init(Omega::System::IWireProxyStubFactory* pPSFactory);
		void close();
		...
		OTL::ObjectPtr<Omega::Remoting::IObjectManager> get_apartment_om(ACE_CDR::UShort apartment_id, Omega::System::IWireProxyStubFactory* pPSFactory);
	...
	// IApartment members
	public:
		void CreateInstance(const Omega::string_t& oid, Omega::Activation::Flags_t flags, Omega::IObject* pOuter, Omega::guid_t& iid, Omega::IObject*& pObject);
	};
}
