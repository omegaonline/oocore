...
namespace OOCore
{
	...
	public:
		...
		void init(UserSession* pSession, Omega::Remoting::MarshalFlags_t flags, Omega::uint32_t channel_id, Omega::Remoting::IObjectManager* pOM, const Omega::guid_t& message_oid);
