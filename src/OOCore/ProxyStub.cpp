...
OOCore::Impl::marshaller_t::marshaller_t(OOCore::ProxyStubManager* manager, Marshall_Flags flags, OOObject::uint16_t wait_secs, OOCore::OutputStream* output, OOObject::uint32_t trans_id) :
	m_in(0),
	m_out(output), 
	m_failed(false), 
	m_manager(manager),
