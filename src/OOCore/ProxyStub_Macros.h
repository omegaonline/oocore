...
#define OOCORE_PS_METATYPE_BUILDER(t)					template <> class type_info_t< OOObject::t > { public: enum { value = OOObject::TypeInfo::t }; }
...
#define OOCORE_PS_DECLARE_METHOD_ID(id,name)		public: typedef \
													...
													id; friend OOUtil::ProxyStub_Base::used_t BOOST_PP_CAT(Method_Id_Gen_,name)(this_class*,id *);

#define OOCORE_PS_DECLARE_METHOD_ID_I(z,n,name)		boost::mpl::if_<boost::mpl::bool_<(sizeof(BOOST_PP_CAT(Method_Id_Gen_,name)((this_class*)0,(boost::mpl::size_t< n >*)0)) == sizeof(OOUtil::ProxyStub_Base::unused_t))>, boost::mpl::size_t< n > 
...
#define OOCORE_PS_PROXY_METHOD_ATTR_I(r,d,n,attr)	BOOST_PP_EXPR_IF(n,|) \
													BOOST_PP_IF(OOCORE_PS_METHOD_ATTRIB_IS_FLAG(attr),OOObject::TypeInfo:: BOOST_PP_CAT(attr,_method),0 )
...
#define OOCORE_PS_IMPL_PROXY_FN(id,n,seq,attr)		{ OOCORE_PS_PARSE_PARAMS(n,seq,OOCORE_PS_PROXY_PARAM_DECL_IMPL) \
													OOUtil::ProxyStub_Base::marshaller_t method_PROXY_FUNC(method(id::value,OOCORE_PS_PROXY_METHOD_ATTR(attr),OOCORE_PS_PROXY_METHOD_WAIT(attr) )); \
...
#define OOCORE_PS_PROXY_PARAM_DECL_IMPL(n,param)	BOOST_PP_IF(OOCORE_PS_PARAM_ATTRIB_IS(param,size_is), \
														OOUtil::ProxyStub_Base::array_t < OOCORE_PS_PARAM_TYPE(param) > BOOST_PP_CAT(PROXY_ARRAY_,OOCORE_PS_PARAM_VAR(param)) BOOST_PP_LPAREN() OOCORE_PS_PARAM_VAR(param) BOOST_PP_COMMA() OOCORE_PS_PARAM_ATTRIB_ELEM(param,size_is,0) BOOST_PP_RPAREN();, \
														BOOST_PP_IF(OOCORE_PS_PARAM_ATTRIB_IS(param,string), \
															OOUtil::ProxyStub_Base::string_t< OOCORE_PS_PARAM_TYPE(param) > BOOST_PP_CAT(PROXY_STRING_,OOCORE_PS_PARAM_VAR(param)) BOOST_PP_LPAREN() OOCORE_PS_PARAM_VAR(param) BOOST_PP_RPAREN();, \
															BOOST_PP_EXPR_IF(OOCORE_PS_PARAM_ATTRIB_IS(param,iid_is), \
																OOUtil::ProxyStub_Base::object_t< OOCORE_PS_PARAM_TYPE(param) > BOOST_PP_CAT(PROXY_OBJECT_,OOCORE_PS_PARAM_VAR(param)) BOOST_PP_LPAREN() OOCORE_PS_PARAM_VAR(param) BOOST_PP_COMMA() OOCORE_PS_PARAM_ATTRIB_ELEM(param,iid_is,0) BOOST_PP_RPAREN(); \
															) \
														) \
													)
...
#define OOCORE_PS_DECLARE_STUB_FN(id)				private: int invoke(const id&, OOObject::ProxyStubManager* manager, iface_class* obj, OOUtil::InputStream_Ptr& input, OOUtil::OutputStream_Ptr& output )
...
#define OOCORE_PS_STUB_PARAM_DECL_IMPL(n,param)		OOUtil::ProxyStub_Base::param_t< \
													BOOST_PP_IF(OOCORE_PS_PARAM_ATTRIB_IS(param,size_is), \
														OOUtil::ProxyStub_Base::array_t < OOCORE_PS_PARAM_TYPE(param) >, \
														BOOST_PP_IF(OOCORE_PS_PARAM_ATTRIB_IS(param,string), \
															OOUtil::ProxyStub_Base::string_t< OOCORE_PS_PARAM_TYPE(param) >, \
															BOOST_PP_IF(OOCORE_PS_PARAM_ATTRIB_IS(param,iid_is), \
																OOUtil::ProxyStub_Base::object_t< OOCORE_PS_PARAM_TYPE(param) >, \
...
#define OOCORE_PS_DECLARE_PARAMINFO_IF(param)			*type = BOOST_PP_IF(OOCORE_PS_PARAM_ATTRIB_IS(param,iid_is), \
															OOObject::TypeInfo::Object, \
															OOUtil::ProxyStub_Base::type_info_t< OOCORE_PS_PARAM_TYPE(param) >::value \
														) | OOCORE_PS_PARAMINFO_ATTRIB(param);

#define OOCORE_PS_PARAMINFO_ATTRIB(param)				BOOST_PP_IF(OOCORE_PS_PARAM_ATTRIB_IS(param,in),OOObject::TypeInfo::in,0) \
														BOOST_PP_EXPR_IF(OOCORE_PS_PARAM_ATTRIB_IS(param,out),| OOObject::TypeInfo::out ) \
														BOOST_PP_EXPR_IF(OOCORE_PS_PARAM_ATTRIB_IS(param,string),| OOObject::TypeInfo::string ) \
														BOOST_PP_EXPR_IF(OOCORE_PS_PARAM_ATTRIB_IS(param,size_is),| OOObject::TypeInfo::array )
...
#define OOCORE_PS_DECLARE_PARAMINFO_ATTRIB_SRCH_I(n,param)		OOUtil::ProxyStub_Base::param_t< \
																BOOST_PP_IF(OOCORE_PS_PARAM_ATTRIB_IS(param,size_is), \
																	OOUtil::ProxyStub_Base::array_t < OOCORE_PS_PARAM_TYPE(param) >, \
																	BOOST_PP_IF(OOCORE_PS_PARAM_ATTRIB_IS(param,string), \
																		OOUtil::ProxyStub_Base::string_t< OOCORE_PS_PARAM_TYPE(param) >, \
...
#define OOCORE_PS_DECLARE_METHODINFO_FN(id,attribute,fn,n,params)	private: int get_method_info(const id&, const OOObject::char_t** method_name, size_t* param_count, OOObject::TypeInfo::Method_Attributes_t* attributes, OOObject::uint16_t* wait_secs) \
																	{ *method_name = #fn; *param_count = n; *wait_secs = OOCORE_PS_PROXY_METHOD_WAIT(attribute); return 0; } \
																	int get_param_info(const id&, size_t param, const OOObject::char_t** param_name, OOObject::TypeInfo::Type_t* type) \
																	{ OOCORE_PS_DECLARE_PARAMINFO_SWITCH(n,params) } \
																	int get_param_attrib(const id&, size_t param, OOObject::TypeInfo::Param_Attrib_Data_t* data) \
...
#define OOCORE_PS_DECLARE_QI_I(id)				OOCORE_PS_DECLARE_METHOD_ID(id,PS) OOCORE_PS_DECLARE_METHODINFO_FN(id,(sync),QueryInterface,2,((in))(const OOObject::guid_t&)(iid)((out)(iid_is(iid)))(OOObject::Object**)(ppVal)) OOObject::int32_t QueryInterface(const OOObject::guid_t& iid, OOObject::Object** ppVal) { return QueryInterface_i(id::value,iid,ppVal); } \
												OOCORE_PS_DECLARE_STUB_FN(id) { OOUtil::ProxyStub_Base::param_t<const OOObject::guid_t&> iid(input); \
												if (iid.failed()) ACE_ERROR_RETURN((LM_ERROR,ACE_TEXT("(%P|%t) Failed to read in param\n")),-1); \
												OOUtil::ProxyStub_Base::param_t<OOUtil::ProxyStub_Base::object_t<OOObject::Object**> > ppVal(iid); \
...
#define OOCORE_PS_BEGIN_PROXY_I(iface,name)			class name : public OOUtil::ProxyStub_Impl<iface> { \
													friend class OOUtil::ProxyStub_Base::metainfo_t; \
													template <class T> int invoke(const T&, OOObject::ProxyStubManager* manager, iface* obj, OOUtil::InputStream_Ptr& input, OOUtil::OutputStream_Ptr& output ) { errno=ENOSYS;ACE_ERROR_RETURN((LM_ERROR,ACE_TEXT("(%P|%t) Invalid method id %d\n"),T::value),-1); } \
													template <class T> int get_method_info(const T&, const OOObject::char_t** method_name, size_t* param_count, OOObject::TypeInfo::Method_Attributes_t* attributes, OOObject::uint16_t* wait_secs) { errno=ENOSYS;ACE_ERROR_RETURN((LM_ERROR,ACE_TEXT("(%P|%t) Invalid method id %d\n"),T::value),-1); } \
													template <class T> int get_param_info(const T&, size_t param, const OOObject::char_t** param_name, OOObject::TypeInfo::Type_t* type) { errno=ENOSYS;ACE_ERROR_RETURN((LM_ERROR,ACE_TEXT("(%P|%t) Invalid method id %d\n"),T::value),-1); } \
													template <class T> int get_param_attrib(const T&, size_t param, OOObject::TypeInfo::Param_Attrib_Data_t* data) { errno=ENOSYS;ACE_ERROR_RETURN((LM_ERROR,ACE_TEXT("(%P|%t) Invalid method id %d\n"),T::value),-1); } \
													name(OOObject::ProxyStubManager* manager, const OOObject::uint32_t& key, iface* obj) : OOUtil::ProxyStub_Impl<iface>(manager,key,obj) {} \
													name(OOObject::ProxyStubManager* manager, const OOObject::uint32_t& key) : OOUtil::ProxyStub_Impl<iface>(manager,key) {} \
													name() : OOUtil::ProxyStub_Impl<iface>() {} \
													friend OOUtil::ProxyStub_Base::unused_t BOOST_PP_CAT(Method_Id_Gen_,PS)(name*,...); \
													...
													int Invoke_i(iface* obj, OOObject::uint32_t& method, OOUtil::Object_Ptr<OOObject::ProxyStubManager>& manager, OOUtil::InputStream_Ptr input, OOUtil::OutputStream_Ptr output) { \
													return OOUtil::ProxyStub_Base::metainfo_t::Invoke(this,obj,manager,method,input,output); } \
													int GetMethodInfo(size_t method, const OOObject::char_t** method_name, size_t* param_count, OOObject::TypeInfo::Method_Attributes_t* attributes, OOObject::uint16_t* wait_secs) { \
													return OOUtil::ProxyStub_Base::metainfo_t::GetMethodInfo(this,method,method_name,param_count,attributes,wait_secs); } \
													int GetParamInfo(size_t method, size_t param, const OOObject::char_t** param_name, OOObject::TypeInfo::Type_t* type) { \
													return OOUtil::ProxyStub_Base::metainfo_t::GetParamInfo(this,method,param,param_name,type); } \
													int GetParamAttributeData(size_t method, size_t param, OOObject::TypeInfo::Param_Attrib_Data_t* data) { \
													return OOUtil::ProxyStub_Base::metainfo_t::GetParamAttributeData(this,method,param,data); } \
													public: typedef name this_class; typedef iface iface_class; \
													static iface* create_proxy(OOObject::ProxyStubManager* manager, const OOObject::uint32_t& key) { name* proxy; ACE_NEW_RETURN(proxy,this_class(manager,key),0); return proxy;} \
													static OOObject::Stub* create_stub(OOObject::ProxyStubManager* manager, const OOObject::uint32_t& key, iface* obj) { name* stub; ACE_NEW_RETURN(stub,this_class(manager,key,obj),0); return stub;} \
													static OOObject::TypeInfo* create_typeinfo() { name* typeinfo; ACE_NEW_RETURN(typeinfo,this_class,0); return typeinfo;} \
...
#define BEGIN_META_INFO_MAP_EX(exp,lib)		static int CreateProxyStub(int type, OOObject::ProxyStubManager* manager, const OOObject::guid_t& iid, OOObject::Object* obj, const OOObject::uint32_t& key, OOObject::Object** proxy, OOObject::Stub** stub, OOObject::TypeInfo** typeinfo, const char* dll_name); \
											...
											extern "C" exp##_Export int CreateProxy(OOObject::ProxyStubManager* manager, const OOObject::guid_t& iid, const OOObject::uint32_t& key, OOObject::Object** proxy) { \
                                            return CreateProxyStub(0,manager,iid,0,key,proxy,0,0,0); } \
                                            extern "C" exp##_Export int CreateStub(OOObject::ProxyStubManager* manager, const OOObject::guid_t& iid, OOObject::Object* obj, const OOObject::uint32_t& key, OOObject::Stub** stub) { \
                                            return CreateProxyStub(1,manager,iid,obj,key,0,stub,0,0); } \
											extern "C" exp##_Export int GetTypeInfo(const OOObject::guid_t& iid, OOObject::TypeInfo** typeinfo) { \
                                            return CreateProxyStub(5,0,iid,0,0,0,0,typeinfo,0); } static OOCORE_PS_BEGIN_PROXY_STUB_MAP(CreateProxyStub)

#define OOCORE_PS_BEGIN_PROXY_STUB_MAP(fn)	int fn(int type, OOObject::ProxyStubManager* manager, const OOObject::guid_t& iid, OOObject::Object* obj, const OOObject::uint32_t& key, OOObject::Object** proxy, OOObject::Stub** stub, OOObject::TypeInfo** typeinfo, const char* dll_name) { \
