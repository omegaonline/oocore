...
namespace OOCore
{
	interface IInterProcessService : public Omega::IObject
	{
		...
		virtual void LaunchObjectApp(const Omega::guid_t& oid, const Omega::guid_t& iid, Omega::Activation::Flags_t flags, Omega::uint32_t envc, const Omega::byte_t* envp, Omega::IObject*& pObject) = 0;
...
(
	...
	OMEGA_METHOD_VOID(LaunchObjectApp,6,((in),const guid_t&,oid,(in),const guid_t&,iid,(in),Activation::Flags_t,flags,(in),uint32_t,envc,(in)(size_is(envc)),const Omega::byte_t*,envp,(out)(iid_is(iid)),IObject*&,pObject))
