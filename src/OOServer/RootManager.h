...
namespace Root
{
	...
	public:
		...
		void accept_client(OOSvrBase::AsyncLocalSocketPtr ptrSocket, const char* session_id);
	...
	private:
		...
		OOBase::SmartPtr<SpawnedProcess> platform_spawn(OOSvrBase::AsyncLocalSocket::uid_t uid, const char* session_id, OOBase::String& strPipe, Omega::uint32_t& channel_id, OOBase::SmartPtr<OOServer::MessageConnection>& ptrMC, bool& bAgain);
		...
		Omega::uint32_t spawn_user(OOSvrBase::AsyncLocalSocket::uid_t uid, const char* session_id, OOBase::SmartPtr<Registry::Hive> ptrRegistry, OOBase::String& strPipe, bool& bAgain);
