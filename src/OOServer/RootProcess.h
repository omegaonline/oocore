...
namespace Root
{
	...
	public:
		...
		virtual OOServer::RootErrCode LaunchService(Root::Manager* pManager, const char* szName, const OOBase::int64_t& key, unsigned long wait_secs, bool async, OOBase::RefPtr<OOBase::Socket>& ptrSocket) const = 0;
