...
bool any_tests()
{
	...
	}
	{
		...
		Omega::any_t a(v);
		TEST(++a.cast<Omega::float4_t&>() == 24.0);
	}
	{
		...
		Omega::any_t a(v);
		TEST(++a.cast<Omega::float8_t&>() == 24.0);
	}
	{
