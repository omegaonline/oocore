...
bool any_tests()
{
	TEST(Omega::any_t().GetType() == Omega::TypeInfo::typeBool);
	...
	// any_cast<T> tests constructor + any_t::operator T()
	{
		...
		Omega::any_t a(v);
		TEST(++static_cast<Omega::byte_t&>(a) == 24);
	}
	{
		Omega::int16_t v = 23;
		...
		Omega::any_t a(v);
		TEST(++static_cast<Omega::int16_t&>(a) == 24);
	}
	{
		Omega::uint16_t v = 23;
		...
		Omega::any_t a(v);
		TEST(++static_cast<Omega::uint16_t&>(a) == 24);
	}
	{
		Omega::int32_t v = 23;
		...
		Omega::any_t a(v);
		TEST(++static_cast<Omega::int32_t&>(a) == 24);
	}
	{
		Omega::uint32_t v = 23;
		...
		Omega::any_t a(v);
		TEST(++static_cast<Omega::uint32_t&>(a) == 24);
	}
	{
		Omega::int64_t v = 23;
		...
		Omega::any_t a(v);
		TEST(++static_cast<Omega::int64_t&>(a) == 24);
	}
	{
		Omega::uint64_t v = 23;
		...
		Omega::any_t a(v);
		TEST(++static_cast<Omega::uint64_t&>(a) == 24);
	}
	{
		...
		Omega::any_t a(v);
		TEST(++static_cast<Omega::float4_t&>(a) == 24.0);
	}
	{
		...
		Omega::any_t a(v);
		TEST(++static_cast<Omega::float8_t&>(a) == 24.0);
	}
	{
...

	{
		...
		Omega::any_t a(v);
		static_cast<Omega::bool_t&>(a) = true;
		TEST(a == true);
		TEST(a);
	}
