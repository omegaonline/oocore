...
{
	Omega::IObject* pObj = Omega::CreateInstance(Omega::Registry::OID_Registry,Omega::Activation::Default,OMEGA_GUIDOF(Omega::Registry::IKey));
	TEST(pObj);
...
bool registry_tests()
{
	...
	pObj = Omega::CreateInstance("Omega.Registry",Omega::Activation::Default,OMEGA_GUIDOF(Omega::Registry::IKey));
	TEST(pObj);
	pObj->Release();
